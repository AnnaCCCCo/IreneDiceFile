...
if string.find(goods, "已发") & string.find(goodsname, "排发货") then
    local num = 0
    local parcelList = {}

    for line in io.lines("C:\\Users\\Administrator\\OneDrive\\Lists\\" .. msg.fromGroup .. "\\Goods_Group" .. msg.fromGroup .. "_" .. pic .. ".csv") do
    ...
    file = io.open("C:\\Users\\Administrator\\OneDrive\\Lists\\" .. msg.fromGroup .. "\\Goods_Group" .. msg.fromGroup .. "_" .. pic .. ".csv", "w")
